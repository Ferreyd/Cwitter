...
<div id="show-groupe" class="content scaffold-show" role="main">
    <fieldset class="buttons">
        <g:link class="btn btn-primary btn-lg" action="follow" value="Follow" name="Follow" resource="${groupeInstance}">Follow</g:link>
        <g:link class="btn btn-danger btn-lg"  action="unfollow" name="Unfollow"  resource="${groupeInstance}" value="Unfollow">Unfollow</g:link>
   </fieldset>
