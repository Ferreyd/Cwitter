...
<div id="show-user" class="content scaffold-show" role="main">
    ...
    <ol class="property-list user">
        ...
        <g:if test="${userInstance?.cweet}">
            <li class="fieldcontain">
                <span id="cweet-label" class="property-label"><g:message code="user.cweet.label"
                                                                         default="Cweet"/></span>

                <g:each in="${userInstance.cweet}" var="c">
                    <span class="property-value" aria-labelledby="cweet-label"><g:link controller="message"
                                                                                       action="show"
        ...
        <g:if test="${userInstance?.follower}">
            <li class="fieldcontain">
                <span id="follower-label" class="property-label"><g:message code="user.follower.label"
                                                                            default="Follower"/></span>

                <g:each in="${userInstance.follower}" var="f">
                    <span class="property-value" aria-labelledby="follower-label"><g:link controller="user"
                                                                                          action="show"
